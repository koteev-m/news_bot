...
class AppWiringSmokeTest {
    ...
    @Test
    fun `public endpoints respond as expected`() =
        testApplication {
    ...
    @Test
    fun `protected endpoints require jwt`() =
        testApplication {
            environment { config = ApplicationConfig("application-test.conf") }
    ...
    private class FakeConnection : InvocationHandler {
        ...
        override fun invoke(
            ...
            when (method.name) {
                ...
                "setSchema", "abort", "setNetworkTimeout",
                -> null
                "getAutoCommit" -> true
                "isClosed" -> false
                "isValid" -> true
    ...
    private class FakeStatement(
        ...
        override fun invoke(
            ...
            when (method.name) {
                ...
                "setPoolable", "setQueryTimeout", "clearBatch", "clearWarnings", "cancel",
                -> null
    ...
    private class FakePreparedStatement(
        ...
        override fun invoke(
            ...
            when (method.name) {
                ...
                "setMaxFieldSize", "setMaxRows", "setQueryTimeout", "setEscapeProcessing",
                -> null
                "getConnection" -> connection
                else -> defaultReturn(method.returnType)
            }
