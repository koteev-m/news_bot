...
class StarsBotCommandsTest {
    @Test
    fun `plans command renders markdown list`() =
        runBlocking {
            val service =
    ...
    @Test
    fun `buy command emits inline keyboard`() =
        runBlocking {
    ...
    @Test
    fun `callback creates invoice once`() =
        runBlocking {
            val service =
                FakeBillingService().apply {
    ...
    @Test
    fun `status reports active subscription`() =
        runBlocking {
    ...
    @Test
    fun `status without subscription reports free`() =
        runBlocking {
            val service =
                FakeBillingService().apply {
    ...
    @Test
    fun `service errors map to user friendly message`() =
        runBlocking {
            val service =
                FakeBillingService().apply {
