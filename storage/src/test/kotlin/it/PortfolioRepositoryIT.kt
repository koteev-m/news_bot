...
class PortfolioRepositoryIT {
    @Test
    fun `repositories persist trades and positions with deduplication`() =
        runBlocking {
            TestDb.withMigratedDatabase { _ ->
                ...
                val thirdTrade =
                    recordTrade("ext-3", thirdTradeTime, TradeSide.SELL, BigDecimal("4"), BigDecimal("260.00"))
