...
* **Админ-роут**: `POST /admin/netflow2/load?sec=SBER&from=YYYY-MM-DD&till=YYYY-MM-DD` (защита `X-Internal-Token`). Ответ: `{ "sec": "...", "from": "...", "till": "...", "windows": N, "rows": M, "maxDate": "YYYY-MM-DD" }`. Неизвестный `sec` → 404, некорректный `sec` → 400 (ValidationError).
