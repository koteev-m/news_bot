...
suspend fun BillingService.applySuccessfulPaymentOutcome(
    ...
    if (this is BillingServiceWithOutcome) {
...
class BillingServiceImpl(
    ...
    override suspend fun createInvoiceFor(
        ...
        runCatchingNonFatal {
            ...
            val plan =
                repo.getActivePlans().firstOrNull { it.tier == tier && it.isActive }
