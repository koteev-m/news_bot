...
class ValuationServiceTest {
    ...
    @Test
    fun `returns zero valuation for empty portfolio`() =
        runBlocking {
    ...
    @Test
    fun `persists valuations and computes drawdown`() =
        runBlocking {
            val positions =
                listOf(
    ...
    private class FakeStorage(
        ...
        override suspend fun listPositions(
            portfolioId: UUID,
        ): DomainResult<List<ValuationService.Storage.PositionSnapshot>> = DomainResult.success(positions)
